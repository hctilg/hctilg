...
<details align="center">
    ...
    <p align="center">
        ...
        <br>
        <br>
        <img alt="Skills" src="https://skillicons.dev/icons?i=raspberrypi,ruby,docker,linux,rust,cpp,bash,regex,qt,selenium,python,django,fastapi,flask,tailwind,nextjs,react,js,vue,nuxtjs,materialui,php,,,typescript,mysql,mongodb,sqlite&perline=7"/>
        <br>
        <br>
