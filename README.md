...
<details align="center">
    ...
    <p align="center">
        ...
        <br>
        <br>
        <img alt="Skills" src="https://skillicons.dev/icons?i=raspberrypi,arch,docker,linux,rust,cpp,bash,regex,qt,selenium,python,django,fastapi,flask,ruby,php,express,typescript,mysql,mongodb,sqlite,tailwind,nextjs,react,js,vue,nuxtjs,materialui&perline=7"/>
        <br>
        <br>
