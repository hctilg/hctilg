...
<p align="center">
  ...
  <br>
  <img alt="Skills" src="https://skillicons.dev/icons?i=raspberrypi,arch,docker,linux,rust,cpp,bash,regex,qt,selenium,python,django,fastapi,flask,php,ruby,express,typescript,mysql,mongodb,sqlite,tailwind,nextjs,react,js,vue,nuxtjs,materialui&perline=7"/>
  <br>
  <br>
